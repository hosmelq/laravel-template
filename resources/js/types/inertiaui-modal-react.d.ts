declare module '@inertiaui/modal-react' {
  ...
  type ModalChildren =
    | ReactNode
    | ((props: ModalChildrenRenderProps) => ReactNode)
  ...
  type ModalLinkChildren =
    | ReactNode
    | ((state: {loading: boolean}) => ReactNode)
  ...
  function getConfigByType(
    isSlideover: boolean,
    key: keyof ModalTypeConfiguration,
  ): unknown
  ...
  const Modal: ForwardRefExoticComponent<
    ModalProps & RefAttributes<ModalInstance | null>
  >
  function ModalLink<T extends ElementType = 'a'>(
